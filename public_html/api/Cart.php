	...
	public function get_cart()
	{
		...
		if(!empty($_SESSION['shopping_cart']))
		{
			...
			if(!empty($variants))
			{
				...
				{
					$variant->current_prices = $this->prices->get_variant_price($variant->id, $session_items[$variant->id]);
					$variant->price = $variant->current_prices->price;
					$variant->compare_price = $variant->current_prices->compare_price;
